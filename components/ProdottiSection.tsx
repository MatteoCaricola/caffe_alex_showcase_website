...
export const ProdottiSection: React.FC<ProdottiSectionProps> = ({
  onDetailClick,
}) => {
  return (
    <section id="prodotti" className="bg-white">
      ...
      <div className="grid md:grid-cols-2 md:min-h-[600px]">
        ...
        <div className="flex flex-col justify-center bg-coffee-50 p-12 md:p-24">
          <span className="mb-4 text-xs font-bold tracking-widest text-coffee-500 uppercase">
            I Nostri Prodotti
          </span>
          <h2 className="mb-6 font-serif text-4xl text-coffee-900 md:text-5xl">
            Coltivati con Passione
          </h2>
          <p className="mb-6 text-coffee-700 leading-relaxed text-lg">
            Da Caffè Alex selezioniamo solo chicchi di caffè di alta qualità,
            provenienti da piantagioni attentamente scelte. Ogni raccolto è
            valorizzato per il suo carattere unico e per il potenziale di
            offrire un’esperienza di gusto autentica.
          </p>
          <p className="mb-10 text-coffee-700 leading-relaxed">
            Il nostro impegno per la qualità nasce all’origine e prosegue in
            ogni fase del processo produttivo, dove competenza e passione si
            incontrano. Ti invitiamo a scoprire il percorso che rende speciali
            le nostre miscele.
          </p>

          <div className="mb-10">
            <span className="font-serif italic text-xl text-coffee-800">
