        ...
        <div className="grid md:grid-cols-2 items-stretch min-h-[750px]">
          ...
          <div className="relative order-2 md:order-1 flex items-end overflow-hidden group">
            <div className="relative w-full h-[600px] md:h-full">
              <img
                src={`${import.meta.env.BASE_URL}assets/homePage/bibliography.jpeg`}
                alt="Img bibliography"
          ...
          <div className="flex flex-col justify-center p-12 md:p-24 order-1 md:order-2">
            <div className="max-w-xl">
              ...
              <p className="mb-8 font-serif text-2xl md:text-3xl leading-snug text-white first-letter:text-7xl first-letter:font-bold first-letter:mr-4 first-letter:float-left first-letter:leading-[0.7] first-letter:text-coffee-300">
                Caffè Alex non è solo una torrefazione: è l’incontro tra
                competenza produttiva e conoscenza profonda del territorio.
              </p>

              <div className="h-[1px] w-24 bg-coffee-700 mb-8"></div>

              <p className="mb-10 text-coffee-50 leading-relaxed font-light text-lg">
                Nasce dall’unione tra l’esperienza della torrefazione Dicos
                Group e la visione imprenditoriale di Alessandro Caricola, con
                l’obiettivo di portare nel canale Ho.Re.Ca. un caffè di qualità
                superiore, frutto di ricerca, studio e selezione accurata delle
                migliori origini.
              </p>

              <p className="mb-10 text-coffee-50 leading-relaxed font-light text-lg">
                Ogni miscela è il risultato di una tostatura lenta e di una
                lunga stagionatura, nel rispetto dei tempi naturali del chicco.
                Un metodo artigianale che valorizza le migliori varietà di
                arabica e robusta, lavorate con un approccio lontano dalle
                logiche industriali. Qualità e sostenibilità diventano così i
                pilastri di un progetto che punta a trasformare una semplice
                bevanda in un’esperienza distintiva per il cliente finale.
              </p>

              <div className="space-y-6">
                <div className="relative italic text-coffee-200 text-xl font-serif">
                  <span className="absolute -left-6 -top-4 text-4xl text-coffee-700 opacity-50">
                    "
                  </span>
              ...
              <div className="mt-20 pt-10 border-t border-coffee-800 flex items-center justify-between">
                <div>
                  <h4 className="font-serif text-3xl tracking-tight text-white italic">
                    Alessandro Caricola
                  </h4>
                  <span className="text-[10px] font-bold tracking-[0.5em] uppercase text-coffee-300 mt-2 block">
                    Distribuzione & Selezione Ho.Re.Ca.
                  </span>
                </div>
